...
const mapsService = {
    ...
    getCityCoordinates() {
        return {
            ...
            'nymburk': { lat: 50.1863, lon: 15.0414 },
            'jaromere': { lat: 50.3609, lon: 15.9290 },
            'jaroměř': { lat: 50.3609, lon: 15.9290 },
            'milovice': { lat: 50.2308, lon: 14.8987 },
            'vodňany': { lat: 49.1478, lon: 14.1747 },
            'vodnany': { lat: 49.1478, lon: 14.1747 },
            'plana': { lat: 49.8622, lon: 12.7447 },
            'planá': { lat: 49.8622, lon: 12.7447 },
            'pelhrimov': { lat: 49.4314, lon: 15.2242 },
            'pelhřimov': { lat: 49.4314, lon: 15.2242 },
            'holešov': { lat: 49.3106, lon: 17.5783 },
            'holesov': { lat: 49.3106, lon: 17.5783 },
            'mnichovo hradiste': { lat: 50.5283, lon: 14.9703 },
            'mnichovo hradiště': { lat: 50.5283, lon: 14.9703 },
            'pocatky': { lat: 49.2947, lon: 15.4742 },
            'počátky': { lat: 49.2947, lon: 15.4742 },
            'caslav': { lat: 49.9122, lon: 15.3889 },
            'čáslav': { lat: 49.9122, lon: 15.3889 },
            'ujezd nad lesy': { lat: 50.1139, lon: 14.6667 },
            'újezd nad lesy': { lat: 50.1139, lon: 14.6667 },
            'rokycany': { lat: 49.7428, lon: 13.5943 },
            'ostrov': { lat: 50.3063, lon: 12.9381 },
            'trebon': { lat: 49.0037, lon: 14.7708 },
            'třeboň': { lat: 49.0037, lon: 14.7708 }
        };
    },
